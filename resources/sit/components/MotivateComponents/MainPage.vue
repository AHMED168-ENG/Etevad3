      ...
      <div class="container d-flex flex-column align-items-center gap-4">
        <div class="mb-2" style="position: relative">
          ...
          <p
            ...
            "
          >
            عش اجواء بطولاتنا وفعاليتنا وتابع اخبارنا لحظة بلحظة مع تغطية مختصرة
            وسريعة
          </p>
        </div>
        <div
...
@media only screen and (max-width: 991px) {report.overview
  .pe {
    display: none;
  }
  h2 {
...
export default {
  ...
  mounted() {
    if (this.$route.params.ico == "coverage") {
      this.news = false;
      this.videos = true;
      this.cls = "";
      this.cls2 = "act";
