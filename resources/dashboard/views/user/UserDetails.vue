                ...
                <form class="form" @supmit="(e) => e.preventDefault()">
                  <div class="form-body">
                    <h4 class="form-section">
                      <i class="ft-home"></i> بيانات المستخدم
                    </h4>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <span class="text-danger" v-if="user.errors.status">
                            {{ user.errors.status[0] }}</span
                          >
                        </div>
                      </div>
                    </div>
...
export default {
  ...
  methods: {
    ...
    getUser() {
      axios
        .get("/api/admin/user/show/" + this.$route.params.id)
        .then((res) => {
    ...
    setImage(e) {
      ...
      axios
        .post(
          "/api/admin/user/upload/file/" + this.$route.params.id,
          formData,
          {
